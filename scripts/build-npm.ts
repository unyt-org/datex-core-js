...
await build({
  ...
  postBuild() {
    ...
    Deno.copyFileSync("src/datex-core/datex_core_js_bg.wasm", "npm/esm/src/datex-core/datex_core_js_bg.wasm");
    ...
    Deno.copyFileSync("rs-lib/datex-core/Cargo.toml", "npm/esm/rs-lib/datex-core/Cargo.toml");
  },
});